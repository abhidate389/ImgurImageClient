...
/**
 * it contain different dependencies which will be required for app
 */
@Module
public class UtilsModule {
    ...
    @Provides
    @Singleton
    ImageSearchApi getImageSearchApiInterface(Retrofit retrofit) {
    ...
    @Provides
    @Singleton
    ImageApiRepository getImageApiRepository(ImageSearchApi imageSearchApi) {
        return new ImageApiRepository(imageSearchApi);
    }
